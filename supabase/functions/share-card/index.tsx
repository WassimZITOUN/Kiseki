  ...
  try {
    ...
    const ir = new ImageResponse(
      (<div style={{ height: "100%", width: "100%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", position: "relative", backgroundColor: "#120d26", color: "#fff", fontFamily: "DM Serif Display", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", position: "relative", zIndex: 10, gap: 40 }}>
          <div style={{ fontSize: 120, fontWeight: "bold", color: "#9572CF", lineHeight: 1 }}>Kiseki</div>
          <div style={{ display: "flex", flexDirection: "column", width: 880, height: 1173, padding: "60px", background: "linear-gradient(135deg, rgba(255, 255, 255, 0.15), rgba(255, 255, 255, 0.05))", border: "2px solid rgba(255, 255, 255, 0.2)", borderRadius: 40, boxShadow: "0 30px 80px rgba(0, 0, 0, 0.4)", justifyContent: "flex-start" }}>
