...
export function VoteCard({ userId, name, avatarUri, selected = false, onPress, disabled = false, compact = false, }) {
    ...
    if (isWeb) {
        return (_jsx(AnimatedTouchable, { onPress: () => onPress?.(userId), onPressIn: handlePressIn, onPressOut: handlePressOut, disabled: disabled, activeOpacity: 0.95, style: [
                {
                ...
                }, children: [_jsx(KAvatar, { uri: avatarUri, name: name, size: avatarSize }), _jsx(KText, { variant: "bodySmall", color: selected ? colors.violet[800] : colors.textPrimary, style: {
    ...
    return (_jsxs(AnimatedTouchable, { onPress: () => onPress?.(userId), onPressIn: handlePressIn, onPressOut: handlePressOut, disabled: disabled, activeOpacity: 0.95, style: [
            {
                borderRadius: resolvedRadius,
                minHeight: cardMinHeight,
            ...
            animatedScale,
                    ...
                    alignItems: "center",
                    justifyContent: "center",
                }, children: [_jsx(KAvatar, { uri: avatarUri, name: name, size: 60 }), _jsx(KText, { variant: "bodySmall", color: selected ? colors.violet[200] : colors.textPrimary, style: {
                            marginTop: spacing.xs,
                            textAlign: "center",
                            fontWeight: "500",
                        }, children: name })] })] }));
