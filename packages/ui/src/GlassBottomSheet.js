...
function SheetContent({ children }) {
    if (Platform.OS === "web") {
        return (<Animated.View entering={SlideInDown.duration(250).springify().damping(40).stiffness(350)} exiting={SlideOutDown.duration(150)} style={{
...
export function GlassBottomSheet({ visible, onClose, children }) {
    ...
    return (<Modal visible={visible} animationType="none" transparent>
      <View style={{
            flex: 1,
