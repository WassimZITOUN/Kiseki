...
import { GlassBottomSheet, ShareResultCard, KText, KButton, colors, spacing, radii, } from "@repo/ui";
export function ShareResultSheet({ visible, onClose, question, winnerName, winnerAvatarUri, winnerVoteCount, groupName, }) {
    ...
    return (_jsxs(GlassBottomSheet, { visible: visible, onClose: onClose, children: [_jsxs(View, { style: {
                    ...
                    marginBottom: spacing.md,
                }, children: [_jsx(KText, { variant: "h3", children: "Partager" }), _jsx(TouchableOpacity, { onPress: onClose, style: {
                        ...
                        }, children: _jsx(KText, { variant: "bodySmall", color: colors.textMuted, children: "Fermer" }) })] }), _jsx(ShareResultCard, { question: question, winnerName: winnerName, winnerAvatarUri: winnerAvatarUri, winnerVoteCount: winnerVoteCount, groupName: groupName }), _jsx(View, { style: { marginTop: spacing.md }, children: _jsx(KButton, { title: "Partager l'image", onPress: handleShareImage, variant: "solid", loading: loadingShare, disabled: loadingShare || loadingCopy, leftIcon: !loadingShare ? (_jsx(Feather, { name: "share-2", size: 16, color: "#fff" })) : undefined }) }), _jsx(View, { style: { marginTop: spacing.sm }, children: _jsx(KButton, { title: "Copier l'image", onPress: handleCopyImage, variant: "glass", loading: loadingCopy, disabled: loadingCopy || loadingShare }) })] }));
}
