    ...
    return (<AuroraScreenWrapper>
      <View style={{
        ...
        <GlassCard style={{ marginBottom: spacing.lg }}>
          <KInput label="Code d'invitation" value={code} onChangeText={(t) => setCode(t.toUpperCase())} placeholder="Ex: A1B2C3D4" maxLength={8} autoCapitalize="characters" style={{
            fontSize: 20,
            letterSpacing: 4,
            textAlign: "center",
        }}/>
        ...
        <KButton title="Rejoindre" onPress={handleJoin} loading={loading}/>
      </View>
    </AuroraScreenWrapper>);
}
